...
Here is a general overview of the most notable files in this repository:
...
- [[file:guix-with-env.scm]] runs =guix= with [[file:modules]] in the load path, used
  in cases where the persistent load path (defined in the [[file:modules/my-guix/home/base][base configuration]])
  gets broken or when initially setting up the system.
